            ...
            <div class="row">
                <div class="col-md-3 df">
                  ...
                  <div class="list-group">
                    ...
                    :class="ChangeClassAndComponent('Users') ? 'active':''"
                    class="list-group-item list-group-item-action v ">
                        Users
                    </a>
                    <a 
                    @click="ChangePage('Categories')"
                    :class="ChangeClassAndComponent('Categories') ? 'active':''"
                     class="list-group-item list-group-item-action v ">
                        Categories
                    </a>
                    <a 
                    @click="ChangePage('Products')"
                    :class="ChangeClassAndComponent('Products') ? 'active':''"
                    class="list-group-item list-group-item-action v ">
                        Products
                    </a>
                    <a 
                    @click="ChangePage('Chart')"
                    :class="ChangeClassAndComponent('Chart') ? 'active':''"
                    class="list-group-item list-group-item-action v ">
                        Chart
                    </a>
